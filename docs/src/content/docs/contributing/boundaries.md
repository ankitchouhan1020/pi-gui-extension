...
description: Green, yellow, and red zones for safe pi-gui customization.
---
...
| Docs / README / AGENTS | `docs/src/content/docs/`, root md | This site and repository guidance |
